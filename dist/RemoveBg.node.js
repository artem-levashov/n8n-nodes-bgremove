    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            try {
                ...
                const ckMode = this.getNodeParameter('ckMode', i);
                const ckColor = this.getNodeParameter('ckColor', i);
                const ckTolerance = this.getNodeParameter('ckTolerance', i);
                const ckFeather = this.getNodeParameter('ckFeather', i);
                const item = items[i];
